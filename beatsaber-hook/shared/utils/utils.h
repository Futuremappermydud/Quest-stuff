...
// #define HOOK_DEF(namespace, className, funcName) \
// retval (*funcName)(__VA_ARGS__) = NULL;
// retval hook_ ## funcName(__VA_ARGS__);
...
#define INSTALL_HOOK_DIRECT(name, addr) \
log(INFO, "Installing 32 bit direct hook!"); \
